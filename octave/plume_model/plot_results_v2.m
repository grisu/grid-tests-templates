...
xlabel('Distance (m)')
ylabel('Thickness ')
plot(distance, thickness_field)
%
figure(4)
title(['Entrainment ',num2str(entrainment),' Difussivity ',num2str(K_h)])
xlabel('Distance (m)')
ylabel('Sum of Thickness ')
plot(sum(thickness_field'))
%
figure(5)
title(['Entrainment ',num2str(entrainment),' Difussivity ',num2str(K_h)])
xlabel('Salinity (pss)')
...
ylabel('Density anomaly (kg.m-3)')
xlabel('Distance (m)')
result=sum((thickness_field.*delta_dens_field)')
plot(1:48, result)
%
...
xlabel('Distance (m)')
result=sum(((thickness_field.*salt_field-thickness_field.*salt(ones(48,1),:)))')
plot(1:48, result)
%
...
xlabel('Distance (m)')
result=plotsum(((thickness_field.*theta_field-thickness_field.*theta(ones(48,1),:)))')
plot(1:48, result)
%
...
%
%
plot(sum(theta_field'))
plot(sum(salt_field'))
plot(sum(salt_field'),sum(theta_field'))
...
xlabel('Distance (m)')
plot(distance,u_field.*thickness_field);
hold off
%
% Velocities 
%
